...
/**
 * This class is extracted from Jasper Server 6.0.1 library maven package
 *
 * version=6.0.1
 * groupId=com.jaspersoft.jasperserver.api.common.impl
 * artifactId=jasperserver-api-common-impl
 *
 * class=com.jaspersoft.jasperserver.api.common.crypto.Cipher
 *
 * The purpose of extracting this copy is to avoid transitive dependence of the above library,
 * because many of those are not published in public maven repo.
 *
 *
 */
